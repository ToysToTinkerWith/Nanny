    ...
    return (
        <div>
            <Grid container>
                ...
                <Typography variant="h5" align="center" style={{ color: "white", backgroundColor: "#6D2222"}}>
                    $19/hr
                </Typography>
            ...
            <Card style={{margin: 15, border: "1px solid black", boxShadow: "0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.2)"}}>
                ...
                <Typography variant="h5" align="center" style={{color: "white", backgroundColor: "#344198"}}>
                    $21/hr
                </Typography>
                <Typography variant="subtitle1" align="center">
            ...
            <Card style={{margin: 15, border: "1px solid black", boxShadow: "0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.2)"}}>
                ...
                <Typography variant="h5" align="center" style={{color: "white", backgroundColor: "#DC990A"}}>
                    $29/hr
                </Typography>
                <Typography variant="subtitle1" align="center">
            ...
            <Card style={{margin: 15, border: "1px solid black", boxShadow: "0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.2)"}}>
                ...
                <Typography variant="h5" align="center" style={{color: "white", backgroundColor: "#397E22"}}>
                    $?/hr
                </Typography>
                <Typography variant="subtitle1" align="center">
                    Pricing may vary
